...
model.add(Dense(100, name='danse_6'))
model.add(Dense(80, name='dense_7'))
model.add(Dense(60, name='dense_8'))
model.add(Dense(40, name='dense_9'))
model.add(Dense(20, name='dense_10'))
model.add(Dense(1, name='dense_11'))
